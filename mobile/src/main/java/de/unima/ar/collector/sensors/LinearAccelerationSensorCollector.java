...
public class LinearAccelerationSensorCollector extends SensorCollector
{
    ...
    {
        String sqlTable = "CREATE TABLE IF NOT EXISTS " + SQLTableName.PREFIX + deviceID + SQLTableName.LINEAR + " (id INTEGER PRIMARY KEY, " + valueNames[3] + " INTEGER UNIQUE, " + valueNames[0] + " REAL, " + valueNames[1] + " REAL, " + valueNames[2] + " REAL)";
