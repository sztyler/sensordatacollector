...
public class ProximitySensorCollector extends SensorCollector
{
    ...
    {
        String sqlTable = "CREATE TABLE IF NOT EXISTS " + SQLTableName.PREFIX + deviceID + SQLTableName.PROXIMITY + " (id INTEGER PRIMARY KEY, " + valueNames[1] + " INTEGER UNIQUE, " + valueNames[0] + " REAL)";
    ...
    {
        DBUtils.flushCache(SQLTableName.PROXIMITY, cache);
    }
}