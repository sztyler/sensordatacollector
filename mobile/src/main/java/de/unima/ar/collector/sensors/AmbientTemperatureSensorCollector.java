...
public class AmbientTemperatureSensorCollector extends SensorCollector
{
    ...
    {
        String sqlTable = "CREATE TABLE IF NOT EXISTS " + SQLTableName.PREFIX + deviceID + SQLTableName.AMBIENT + " (id INTEGER PRIMARY KEY, " + valueNames[1] + " INTEGER UNIQUE, " + valueNames[0] + " REAL)";
    ...
    {
        DBUtils.flushCache(SQLTableName.AMBIENT, cache);
    }
}